...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'chris_zhan@mikejhan.onmicrosoft.com',
  ...
  email: 'mailto:mikejhan4455@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/mikejhan4455',
    },
    {
      name: 'Blog',
      link: 'https://blog.mikejhan.xyz',
    },
  ],
